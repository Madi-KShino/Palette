...
extension UIView {
    ...
    func anchor(toProperties top: NSLayoutYAxisAnchor?, bottom: NSLayoutYAxisAnchor?, leading: NSLayoutXAxisAnchor?, trailing: NSLayoutXAxisAnchor?, topPadding: CGFloat, bottomPadding: CGFloat, leadingPadding: CGFloat, tralingPadding: CGFloat, width: CGFloat? = nil, height: CGFloat? = nil) {
        ...
        if let trailing = trailing {
            self.trailingAnchor.constraint(equalTo: trailing, constant: tralingPadding).isActive = true
        }
        if let width = width {
